...
- Name: e2e/employee.spec.ts >> dashboard displays employee count widget
- Location: e2e/employee.spec.ts:44:5
...
Locator: getByText('Employee Count')
Expected: visible
Error: strict mode violation: getByText('Employee Count') resolved to 2 elements:
    ...
    2) <p class="MuiTypography-root MuiTypography-body1 css-1bxyocw-MuiTypography-root">Employee Count</p> aka getByText('Employee Count', { exact: true })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Employee Count')
