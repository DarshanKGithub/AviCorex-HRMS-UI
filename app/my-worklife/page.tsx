    ...
    <Box sx={{ bgcolor: '#f4f6fc', minHeight: '100vh', px: { xs: 2, md: 4 }, py: 3 }}>
      ...
      <Stack spacing={4} sx={{ mt: 2 }}>
        <Box>
          ...
          <Typography sx={{ color: '#64748b', maxWidth: 760, mt: 0.5 }}>
          ...
          {[
            ...
            <Grid item xs={12} md={4} key={stat.label}>
              <Card sx={{ ...commonCardStyles, p: 3 }}>
                <Box sx={{ width: 44, height: 44, borderRadius: 2.5, bgcolor: stat.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', color: stat.color, mb: 2 }}>
                  {stat.icon}
                </Box>
                <Typography variant="h3" sx={{ fontWeight: 900, color: '#1e293b', mb: 1, letterSpacing: '-0.02em', wordBreak: 'break-word' }}>{stat.value}</Typography>
                <Typography sx={{ color: '#64748b', fontSize: '0.85rem', fontWeight: 600 }}>{stat.label}</Typography>
                <Typography sx={{ mt: 0.5, color: '#94a3b8', fontSize: '0.75rem' }}>{stat.helper}</Typography>
              </Card>
            </Grid>
          ))}
        </Grid>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Card sx={{ ...commonCardStyles, p: 4, background: 'linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
              ...
              <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 1, position: 'relative', zIndex: 1 }}>
                <Avatar sx={{ width: 56, height: 56, bgcolor: 'rgba(255,255,255,0.2)', color: '#fff', fontSize: '1.25rem', fontWeight: 800 }}>
              ...
              <Chip label={user?.role || 'Employee'} sx={{ mt: 1, mb: 4, bgcolor: 'rgba(255,255,255,0.2)', color: '#fff', fontWeight: 800, position: 'relative', zIndex: 1 }} />
          ...
          <Grid item xs={12} md={7}>
            <Card sx={{ ...commonCardStyles, p: 4 }}>
              ...
              <Typography sx={{ color: '#94a3b8', fontSize: '0.85rem', mb: 3 }}>Shortcuts to the areas employees visit most.</Typography>
